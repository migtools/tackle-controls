...
public class BusinessServiceTest extends SecuredResourceTest {
    ...
    public void testBusinessServicesListHalEndpoint() {
        given()
                ...
                .body("_embedded.business-service.size()", is(3),
                        "_embedded.business-service.id", containsInRelativeOrder(3, 2, 1),
                        ...
                        "_embedded.business-service[1]._links.self.href", is("http://localhost:8081/controls/business-service/2"),
                        "_links.size()", is(4));
    }
    ...
    public void testBusinessServicesFilteredSingleParamListHalEndpoint() {
        given()
                ...
                .body("_embedded.business-service.size()", is(1),
                        "_embedded.business-service.id", contains(1),
                        "_embedded.business-service.name", contains("Home Banking BU"),
                        "_embedded.business-service[0]._links.size()", is(5),
                        "_embedded.business-service[0]._links.self.href", is("http://localhost:8081/controls/business-service/1"),
                        "_links.size()", is(4));
    }
    ...
    public void testBusinessServicesListEndpoint() {
        ...
        given()
                ...
                .statusCode(200)
                .body("size()", is(3),
                        "id", containsInRelativeOrder(1, 2, 3),
    ...
    public void testBusinessServicePaginationWithPrevAndNextLinks() {
        given()
                ...
                .statusCode(200)
                .body("_embedded.business-service.size()", is(1),
                        "_embedded.business-service.id", containsInRelativeOrder( 1),
    ...
    public void testBusinessServicePaginationWithSameNextAndLastLinks() {
        ...
        Response response = given()
                ...
                .body("_embedded.business-service.size()", is(1),
                        ...
                        "_embedded.business-service[0]._links.self.href", is("http://localhost:8081/controls/business-service/1"),
                        "_links.size()", is(5),
                        "_links.next.href", is("http://localhost:8081/controls/business-service?page=1&size=1&sort=name&name=bank&name=line"),
                        "_links.last.href", is("http://localhost:8081/controls/business-service?page=1&size=1&sort=name&name=bank&name=line"))
                .extract().response();
        assertThat(response.headers().getValues("Link"), containsInRelativeOrder(
                "<http://localhost:8081/controls/business-service?page=0&size=1&sort=name&name=bank&name=line>; rel=\"first\"",
                "<http://localhost:8081/controls/business-service?page=1&size=1&sort=name&name=bank&name=line>; rel=\"last\"",
                "<http://localhost:8081/controls/business-service?page=1&size=1&sort=name&name=bank&name=line>; rel=\"next\""));
    }
